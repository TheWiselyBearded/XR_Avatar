...
Shader "Artanim/HairShader" {
	Properties{
		...
		_Cutoff("Alpha Cutoff", Range(0.01,1)) = 0.5
		 [Enum(No,2,Yes,0)] _TwoSided("Two Sided", Float) = 2.000000 
		[Enum(No,0,Yes,1)] _FlipNormals("Flip Normals", Float) = 1.000000
		}
		SubShader{
			...
			void surf(Input IN, inout SurfaceOutputStandard o) {
				...
				if (_FlipNormals >= 1 && IN.facing < 0.5)
					o.Normal *= -1.0;
			}
			ENDCG
		}
